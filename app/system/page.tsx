...
const DEFAULT_STORES: StoreRecord[] = [
  ...
  { id: "s5", code: "CYH", name: "Tube Coffee CYH", brand: "Tube Coffee" },
  ...
  { id: "s9", code: "ATN", name: "Tube Coffee ATN", brand: "Tube Coffee" },
  { id: "s10", code: "POK", name: "OnMart POK", brand: "OnMart" },
...
const DEFAULT_ITEMS: ItemRecord[] = [
  { item_code: "SM017", description_khmer: "សាច់ជ្រូកអាំង (50g)", brand: "Tube Coffee", category: "Semi Product Meat", uom: "Pack", cpu: 0.85, opening_stock: 450 },
  { item_code: "D0011", description_khmer: "ពងមាន់ (1pcs)", brand: "Tube Coffee", category: "Dry Store", uom: "PCS", cpu: 0.12, opening_stock: 800 },
  { item_code: "SM010", description_khmer: "សាច់ គោ (50g)", brand: "Tube Coffee", category: "Semi Product Meat", uom: "Pack", cpu: 1.10, opening_stock: 300 },
  { item_code: "V0001", description_khmer: "ស្លឹកខ្ទឹម (300g)", brand: "Tube Coffee", category: "Daily Product", uom: "Pack", cpu: 0.70, opening_stock: 45 },
  { item_code: "S0001", description_khmer: "ទឹកផ្សំបាយមាន់គ្រឿង (300g)", brand: "Tube Coffee", category: "Semi Product Sauce", uom: "Pack", cpu: 0.60, opening_stock: 60 },
  { item_code: "10130122", description_khmer: "ប៉ាស្តាសាច់ក្រក (180g)", brand: "OnMart", category: "FINISHED PRODUCT", uom: "Pack", cpu: 1.50, opening_stock: 60 },
  { item_code: "10160147", description_khmer: "ប្រហិតបង្កង (5stick)", brand: "OnMart", category: "Semi Product Sauce", uom: "Pack", cpu: 1.20, opening_stock: 90 },
  { item_code: "10150139", description_khmer: "ស្ពៃក្តោប (500g)", brand: "OnMart", category: "Dry Store", uom: "Pack", cpu: 0.60, opening_stock: 120 }
];

export default function CPUSystemApp() {
  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    if (inputPasscode === adminPassword || inputPasscode === "0203" || inputPasscode === "admin8888") {
      ...
      setLoginError("Password មិនត្រឹមត្រូវទេ! សូមសាកល្បងម្តងទៀត។");
    }
  };
  ...
  const logAccess = (userName: string, role: "ADMIN" | "STAFF") => {
    ...
    const updated = [newLog, ...accessLogs].slice(0, 50); // Keep last 50
      ...
      <div className="min-h-screen bg-slate-900 flex items-center justify-center p-4 selection:bg-emerald-500 selection:text-white">
        ...
        <div className="relative z-10 w-full max-w-md bg-slate-800/90 border border-slate-700/80 rounded-3xl p-6 sm:p-8 shadow-2xl shadow-black/60 backdrop-blur-md">
          ...
          <div className="flex flex-col items-center text-center mb-6">
            ...
            <p className="text-[11px] text-slate-400 mt-1">Tube Coffee+ &amp; OnMart Operations</p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                placeholder="PIN (Staff: 8899 / tube1234, Admin: 0203 / admin8888)"
            ...
            <button
              type="submit"
              className="w-full py-3 bg-emerald-600 hover:bg-emerald-500 active:bg-emerald-700 text-white rounded-xl text-xs font-bold shadow-lg shadow-emerald-950 flex items-center justify-center gap-2 transition-all uppercase tracking-wider mt-2"
            >
          ...
          <div className="mt-6 pt-4 border-t border-slate-700/60 text-[11px] text-slate-400 space-y-1">
            ...
            <p>• <strong>Staff Mode:</strong> <code>8899</code> ឬ <code>tube1234</code> (បញ្ចូលទិន្នន័យទូទៅ)</p>
            <p>• <strong>Admin / Manager Mode:</strong> <code>0203</code> ឬ <code>admin8888</code> (មើលតម្លៃ និងគ្រប់គ្រង)</p>
          </div>
        </div>
      </div>
    );
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 flex flex-wrap items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[11px] text-slate-500 font-medium">Tube Coffee+ &amp; OnMart Central Hub</p>
            </div>
          </div>

          {/* Right User Badge & Tools */}
      ...
      <main className="max-w-7xl mx-auto p-4 sm:p-6 space-y-6">
        ...
        {activeTab === "stores" && (
          <div className="space-y-6">
            ...
            {/* TOP 2 TUBE & TOP 2 ONMART LEADERBOARD */}
            ...
            {/* STORE DISTRIBUTION TABLE & FILTERS */}
            <div className="bg-white rounded-2xl border border-slate-200 shadow-xs overflow-hidden">
              ...
              <div className="p-4 sm:p-5 border-b border-slate-200 flex flex-wrap items-center justify-between gap-4 bg-slate-50/50">
                ...
                <div className="flex items-center gap-2 w-full sm:w-auto">
                  ...
                  {/* Add Store Button (Admin only or all) */}
                  <button
                    onClick={() => setShowAddStoreModal(true)}
                    className="flex items-center gap-1.5 px-3.5 py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl text-xs font-bold transition-colors shrink-0 shadow-xs"
                  >
              ...
              <div className="p-4 sm:p-5 border-b border-slate-200 flex flex-wrap items-center justify-between gap-4 bg-slate-50/50">
                ...
                <div className="flex items-center gap-2 w-full sm:w-auto">
                  ...
                  <button
                    ...
                    className="flex items-center gap-1.5 px-3.5 py-2 bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl text-xs font-bold transition-colors shrink-0 shadow-xs"
                  >
                    <Plus className="w-4 h-4" />
